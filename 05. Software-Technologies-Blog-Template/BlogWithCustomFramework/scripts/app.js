(function () {
    ...
    let _guestCredentials = "ffeba0e9-7115-498b-806d-0364dd9149db.Vg88JuHznIGCgZ8+vT1laq2sqkwkoNOiIdeNg/o3MLM="; // Create a guest user using PostMan/RESTClient/Fiddler and place his authtoken here...
    ...
    onRoute("#/", function () {
        ...
        else{homeController.showGuestPage()
        } ;
    });
